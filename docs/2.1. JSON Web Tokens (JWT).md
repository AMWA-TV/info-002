...
The Header is used to identify which algorithm was used to generate the Signature. In accordance with [IS-10](https://specs.amwa.tv/is-10/branches/v1.0-dev/docs/4.4._Behaviour_-_Access_Tokens.html), the `alg` field in the header is set to RS512.
...
The [IS-10 specification](https://specs.amwa.tv/is-10/branches/v1.0-dev/docs/4.4._Behaviour_-_Access_Tokens.html#registered-claims) gives details of how NMOS API Clients and Servers should use registered claims.
