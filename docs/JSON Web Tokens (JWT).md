...
IS-10 has defined some private claims which are used to control read/write access to APIs. These are configured in the Authorization Server and are covered in more detail in [that section](3.0.%20Authorization%20Server%20Setup.md#private-claims).
