...
Further details on WebSocket authorization can be found in [BCP-003-02](https://specs.amwa.tv/bcp-003-02/branches/v1.0.x/docs/1.0._Authorization_Practice.html#is-07---event-and-tally).
